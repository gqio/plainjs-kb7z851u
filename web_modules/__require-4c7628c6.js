 ...
 */if(typeof window!=="undefined"){(window["litHtmlVersions"]||(window["litHtmlVersions"]=[])).push("1.2.1");}const html=(strings,...values)=>new TemplateResult(strings,values,"html",defaultTemplateProcessor);const svg=(strings,...values)=>new SVGTemplateResult(strings,values,"svg",defaultTemplateProcessor);var litHtml=Object.freeze({__proto__:null,html:html,svg:svg,DefaultTemplateProcessor:DefaultTemplateProcessor,defaultTemplateProcessor:defaultTemplateProcessor,directive:directive,isDirective:isDirective,removeNodes:removeNodes,reparentNodes:reparentNodes,noChange:noChange,nothing:nothing,AttributeCommitter:AttributeCommitter,AttributePart:AttributePart,BooleanAttributePart:BooleanAttributePart,EventPart:EventPart,isIterable:isIterable,isPrimitive:isPrimitive,NodePart:NodePart,PropertyCommitter:PropertyCommitter,PropertyPart:PropertyPart,parts:parts,render:render,templateCaches:templateCaches,templateFactory:templateFactory,TemplateInstance:TemplateInstance,SVGTemplateResult:SVGTemplateResult,TemplateResult:TemplateResult,createMarker:createMarker,isTemplatePartActive:isTemplatePartActive,Template:Template});function unwrapGetStory(s,c){return s&&typeof s==="function"?s(c):s}const fullBody=(s,c)=>html`
    ...
    ${unwrapGetStory(s,c)}
  `;const centered=(s,c)=>fullBody(html`
    <div
      style="display: flex; flex-direction: column; align-items: center; justify-content: center; height: 100vh;"
    >
      ${unwrapGetStory(s,c)}
    </div>
  `);const loremIpsum="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.";const loremIpsumSandwich=(s,c)=>html`
  <p>${loremIpsum}</p>
  ${unwrapGetStory(s,c)}
  <p>${loremIpsum}</p>
`;function background(color){return (s,c)=>html`
    <style>
      body {
    ...
    ${unwrapGetStory(s,c)}
  `}var index=Object.freeze({__proto__:null,fullBody:fullBody,centered:centered,loremIpsumSandwich:loremIpsumSandwich,background:background});

function require(library){
    switch(library){
           case '@webcomponents-dev/decorators-lit' : return index
     case 'lit-html' : return litHtml
        default: throw new Error('Unable to find '+library);
      }
    }

export { litHtml as l, require as r };
